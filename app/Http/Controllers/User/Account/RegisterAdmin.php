...
class RegisterAdmin extends Controller
{
    ...
    {
        $users = $this->user->get();
        return view('admin.akun.register.admin')->with(compact('users'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $this->user->create($d);
            return redirect('/admin/develop/register')->with('pesan_sukses', 'User bertambah');
        } catch (\Throwable $th) {
            //throw $th;
            return redirect('/admin/develop/home')->with('pesan_error', $th->getMessage());
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/admin/develop/register')->with('pesan_sukses', 'User diperbaharui');
        } catch (\Throwable $th) {
            //throw $th;
            return redirect('/admin/develop/home')->with('pesan_error', $th->getMessage());
        }
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect('/admin/develop/register')->with('pesan_sukses', 'User dihapus');
        } catch (\Throwable $th) {
            //throw $th;
            return redirect('/admin/develop/home')->with('pesan_error', $th->getMessage());
        }
