...
class Foto extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.akun.tampil.foto')->with(compact('foto', 'kategori'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            if ($this->kategori->where(['kategori' => $d])->first()) {
                # code...
                return redirect('/admin/develop/fotoku')->with('pesan_error', 'Kategori sudah ada');
            }
            $this->kategori->create($n);
            return redirect('/admin/develop/fotoku')->with('pesan_sukses', 'Kategori bertambah');
        } catch (\Throwable $th) {
            return redirect('/admin/develop/fotoku')->with('pesan_error', $th->getMessage());
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $this->foto->create($d);
            return redirect('/admin/develop/fotoku')->with('pesan_sukses', 'Foto bertambah');
        } catch (\Throwable $th) {
            return redirect('/admin/develop/fotoku')->with('pesan_error', $th->getMessage());
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/admin/develop/fotoku')->with('pesan_sukses', 'Foto diganti');
        } catch (\Throwable $th) {
            return redirect('/admin/develop/fotoku')->with('pesan_error', $th->getMessage());
        }
    }
