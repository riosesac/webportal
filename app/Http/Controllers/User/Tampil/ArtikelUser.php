...
class ArtikelUser extends Controller
{
    private $model;
    public $artikel;
    public $kategori;
    ...
    public function index()
    {
        ...
        return view('admin.akun.tampil.artikeluser')->with(compact('artikel', 'kategori'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            if ($this->kategori->where(['kategori' => $d])->first()) {
                # code...
                return redirect('/admin/user/artikelku')->with('pesan_error', 'Kategori sudah ada');
            }
            $this->kategori->create($n);
            return redirect('/admin/user/artikelku')->with('pesan_sukses', 'Kategori bertambah');
        } catch (\Throwable $th) {
            return redirect('/admin/user/artikelku')->with('pesan_error', $th->getMessage());
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect('/admin/user/artikelku')->with('pesan_sukses', 'Artikel bertambah');
        } catch (\Throwable $th) {
            return redirect('/admin/user/artikelku')->with('pesan_error', $th->getMessage());
        }
    }
