...
class VideoUser extends Controller
{
    private $model;
    public $video;
    public $kategori;
    ...
    public function index()
    {
        ...
        return view('admin.akun.tampil.videouser')->with(compact('video', 'kategori'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            if ($this->kategori->where(['kategori' => $d])->first()) {
                # code...
                return redirect('/admin/user/videoku')->with('pesan_error', 'Kategori sudah ada');
            }
            $this->kategori->create($n);
            return redirect('/admin/user/videoku')->with('pesan_sukses', 'Kategori bertambah');
        } catch (\Throwable $th) {
            return redirect('/admin/user/videoku')->with('pesan_error', $th->getMessage());
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $this->video->create($d);
            return redirect('/admin/user/videoku')->with('pesan_sukses', 'Video bertambah');
        } catch (\Throwable $th) {
            return redirect('/admin/user/videoku')->with('pesan_error', $th->getMessage());
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/admin/user/videoku')->with('pesan_sukses', 'Video diganti');
        } catch (\Throwable $th) {
            return redirect('/admin/user/videoku')->with('pesan_error', $th->getMessage());
        }
    }
