              ...
              <div class="card">
                ...
                <div class="modal fade" id="modal-xl">
                  <div class="modal-dialog modal-xl">
                    <form enctype="multipart/form-data" method="POST" action="{{url('/admin/user/artikelku/create')}}">{{ csrf_field() }}
                  ...
                  <div class="modal fade" id="modal-default">
                    ...
                    <form enctype="multipart/form-data" method="POST" action="{{url('/admin/user/artikelku/kategori/create')}}">{{ csrf_field() }}
                        <div class="modal-content">
                          <div class="modal-header">
