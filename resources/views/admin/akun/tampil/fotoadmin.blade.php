            ...
            <div class="card">
              ...
              <div class="modal fade" id="modal-xl">
                <div class="modal-dialog modal-xl">
                  <form enctype="multipart/form-data" method="POST" action="{{url('/admin/admin/fotoku/create')}}">{{ csrf_field() }}
                ...
                <div class="modal fade" id="modal-default">
                  ...
                  <form enctype="multipart/form-data" method="POST" action="{{url('/admin/admin/fotoku/kategori/create')}}">{{ csrf_field() }}
                      <div class="modal-content">
                        <div class="modal-header">
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <div class="modal fade" id="modal-xl{{$data->id}}">
                      <div class="modal-dialog modal-xl">
                        <form enctype="multipart/form-data" method="POST" action="{{url('/admin/admin/fotoku/update/'.$data->id)}}">{{ csrf_field() }}
                          <div class="modal-content">
                            <div class="modal-header">
                  ...
                  <a type="button" class="btn btn-danger" href="{{url('/admin/admin/fotoku/delete/'.$data->id)}}">Hapus</a>
                    </td>
                  </tr>
