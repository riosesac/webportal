            ...
            <div class="card">
              ...
              <div class="modal fade" id="modal-xl">
                <div class="modal-dialog modal-xl">
                  <form enctype="multipart/form-data" method="POST" action="{{url('/admin/user/videoku/create')}}">{{ csrf_field() }}
                ...
                <div class="modal fade" id="modal-default">
                  ...
                  <form enctype="multipart/form-data" method="POST" action="{{url('/admin/user/videoku/kategori/create')}}">{{ csrf_field() }}
                      <div class="modal-content">
                        <div class="modal-header">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                      <video width="400" controls>
                        <source src="{!! url('video/'.$data->video) !!}" type="video/mp4">
                        <source src="{!! url('video/'.$data->video) !!}" type="video/webm">
                        <source src="{!! url('video/'.$data->video) !!}" type="video/ogg">
                        <source src="{!! url('video/'.$data->video) !!}" type="video/avi">
                      </video>
                    </td>
                    <td>{{$data->kat}}</td>
                    <td>
                    ...
                    <div class="modal fade" id="modal-xl{{$data->id}}">
                      <div class="modal-dialog modal-xl">
                        <form enctype="multipart/form-data" method="POST" action="{{url('/admin/user/videoku/update/'.$data->id)}}">{{ csrf_field() }}
                          <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="card-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <div class="custom-file">
                                        <input type="file" name="video" class="custom-file-input" id="exampleInputFile">
                                        <label class="custom-file-label" for="exampleInputFile">Input Ulang video</label>
                                      </div>
                                      <div class="input-group-append">
                                        <span class="input-group-text">Upload</span>
                                      </div>
                  ...
                  <a type="button" class="btn btn-danger" href="{{url('/admin/user/videoku/delete/'.$data->id)}}">Hapus</a>
                    </td>
                  </tr>
