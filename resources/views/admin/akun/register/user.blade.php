            ...
            <div class="card">
              ...
              <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                  <form enctype="multipart/form-data" method="POST" action="{{ url('/admin/admin/register/create')}}">{{ csrf_field() }}
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <a type="button" class="btn btn-danger" href="{{ url('/admin/admin/register/delete/'.$user->id)}}">Hapus</a>
                    </td>
                  </tr>
              <div class="modal fade" id="modal-default{{$user->id}}">
                <div class="modal-dialog">
                  <form enctype="multipart/form-data" method="POST" action="{{ url('/admin/admin/register/update/'.$user->id)}}">{{ csrf_field() }}
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">Create User</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
