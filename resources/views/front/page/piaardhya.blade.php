            ...
            <div class="container" style="padding-bottom: 50px;">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        <h2 class="module-title font-alt" style="padding-top:50px;">PROFIL PIA ARDHYA GARINI D.III KOOPSAU III</h2>
                ...
                <div class="row">
                    <div class="col-sm-8">
                      <div class="row multi-columns-row post-columns">
                        @foreach ($artikel as $piaardhya)
                        <div class="col-sm-6 col-md-4 col-lg-4">
                          <div class="post">
                            <div class="post-thumbnail">
                              <a href="#">
                                @if ($piaardhya->foto)
                                <a href="#"><img src="{{ asset('foto/'.$piaardhya->foto) }}" alt="Blog-post Thumbnail"/></a>    
                                @else
                            ...
                            <div class="post-header font-alt">
                              <h2 class="post-title"><a href="#">{{ $piaardhya->judul }}</a></h2>
                              <div class="post-meta">&nbsp;| {{ date('dMY',strtotime($piaardhya->created_at)) }}| {{ $piaardhya->kat }}
                              </div>
                            </div>
                            <div class="post-entry">
                              {!! Str::limit($piaardhya->artikel, $limit = 100) !!}
                            </div>
                            <div class="post-more"><a class="more-link" href="{{url("/data/".$piaardhya->slug)}}">Read more</a></div>
                          </div>
                        </div>
                        @endforeach
                      </div>
