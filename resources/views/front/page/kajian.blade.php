...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <section class="home-section home-parallax home-fade home-full-height bg-dark-60 agency-page-header" data-background="assets/images/cn295v6.jpg" id="home">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                      <h2 class="module-title font-alt" style="padding-top:50px;">KAJIAN STAF AHLI KOOPSAU III</h2>
                      <div class="module-subtitle font-serif">Komando Operasi TNI Angkatan Udara III</div>
                    </div>
                  </div>
                <div class="row post-masonry post-columns">
                  @foreach ($artikel as $kajian)
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="post">
                      <div class="post-thumbnail">
                        <a href="#">
                          @if ($kajian->foto)
                          <a href="#"><img src="{{ asset('foto/'.$kajian->foto) }}" alt="Blog-post Thumbnail"/></a>    
                          @else
                      ...
                      <div class="post-header font-alt">
                        <h2 class="post-title"><a href="#">{{ $kajian->judul }}</a></h2>
                        <div class="post-meta">&nbsp;| {{ date('dMY',strtotime($kajian->created_at)) }}| {{ $kajian->kat }}
                        </div>
                      </div>
                      <div class="post-entry">
                        {!! Str::limit($kajian->artikel, $limit = 100) !!}
                      </div>
                      <div class="post-more"><a class="more-link" href="{{url("/data/".$kajian->slug)}}">Read more</a></div>
                    </div>
                  </div>
                        @endforeach
                </div>
