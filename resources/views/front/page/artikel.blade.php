...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <section class="home-section home-parallax home-fade home-full-height bg-dark-60 agency-page-header" data-background="assets/images/cn235v2.jpg" id="home">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                      <h2 class="module-title font-alt" style="padding-top:50px;">BUKU DAN ARTIKEL</h2>
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="post">
                      <div class="post-thumbnail">
                        <a href="#">
                          @if ($article->foto)
                          <a href="#"><img src="{{ asset('foto/'.$article->foto) }}" alt="Blog-post Thumbnail"/></a>    
                          @else
                      ...
                      <div class="post-header font-alt">
                        <h2 class="post-title"><a href="#">{{ $article->judul }}</a></h2>
                        <div class="post-meta">&nbsp;| {{ date('dMY',strtotime($article->created_at)) }}| {{ $article->kat }}
                        </div>
                      </div>
                      <div class="post-entry">
                        {!! Str::limit($article->artikel, $limit = 100) !!}
                      </div>
                      <div class="post-more"><a class="more-link" href="{{url("/data/".$article->slug)}}">Read more</a></div>
                    </div>
                  </div>
                        @endforeach
                </div>
