...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <div class="main">
        <section class="module  bg-dark-60 pt-0 pb-0 parallax-bg " data-background="assets/images/sejarah1.jpeg" id="team">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                      <h2 class="module-title font-alt" style="padding-top:50px;">ARSIP KOOPSAU III</h2>
                      <div class="module-subtitle font-serif">Komando Operasi TNI Angkatan Udara III</div>
                    </div>
                  </div>
                <div class="row post-masonry post-columns">
                  @foreach ($artikel as $arsip)
                        <div class="col-sm-6 col-md-4 col-lg-4">
                          <div class="post">
                            <div class="post-thumbnail">
                              <a href="#">
                                @if ($arsip->foto)
                                <a href="#"><img src="{{ asset('foto/'.$arsip->foto) }}" alt="Blog-post Thumbnail"/></a>    
                                @else
                            ...
                            <div class="post-header font-alt">
                              <h2 class="post-title"><a href="#">{{ $arsip->judul }}</a></h2>
                              <div class="post-meta">&nbsp;| {{ date('dMY',strtotime($arsip->created_at)) }}| {{ $arsip->kat }}
                              </div>
                            </div>
                            <div class="post-entry">
                              {!! Str::limit($arsip->artikel, $limit = 100) !!}
                            </div>
                            <div class="post-more"><a class="more-link" href="{{url("/data/".$arsip->slug)}}">Read more</a></div>
                          </div>
                        </div>
                        @endforeach
                </div>
