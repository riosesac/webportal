...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <section class="home-section home-parallax home-fade home-full-height bg-dark-60 agency-page-header" data-background="assets/images/cn295v2.jpg" id="home">
        ...
        <section class="module  bg-dark-60 pt-0 pb-0 parallax-bg " data-background="assets/images/artikel.jpg" id="team">
            <div class="container">
                ...
                <div class="row post-masonry post-columns">
                  @foreach ($artikel as $buletin)
                  <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="post">
                      <div class="post-thumbnail">
                        <a href="#">
                          @if ($buletin->foto)
                          <a href="#"><img src="{{ asset('foto/'.$buletin->foto) }}" alt="Blog-post Thumbnail"/></a>    
                          @else
                      ...
                      <div class="post-header font-alt">
                        <h2 class="post-title"><a href="#">{{ $buletin->judul }}</a></h2>
                        <div class="post-meta">&nbsp;| {{ date('dMY',strtotime($buletin->created_at)) }}| {{ $buletin->kat }}
                        </div>
                      </div>
                      <div class="post-entry">
                        {!! Str::limit($buletin->artikel, $limit = 100) !!}
                      </div>
                      <div class="post-more"><a class="more-link" href="{{url("/data/".$buletin->slug)}}">Read more</a></div>
                    </div>
                  </div>
                        @endforeach
                </div>
