            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                      <h2 class="module-title font-alt" style="padding-top:50px;">PENERANGAN KOOPSAU III</h2>
                      <div class="module-subtitle font-serif">Komando Operasi TNI Angkatan Udara III</div>
                    </div>
                  </div>
                <div class="row post-masonry post-columns">
                  @foreach ($artikel as $penerangan)
                        <div class="col-sm-6 col-md-4 col-lg-4">
                          <div class="post">
                            <div class="post-thumbnail">
                              <a href="#">
                                @if ($penerangan->foto)
                                <a href="#"><img src="{{ asset('foto/'.$penerangan->foto) }}" alt="Blog-post Thumbnail"/></a>    
                                @else
                            ...
                            <div class="post-header font-alt">
                              <h2 class="post-title"><a href="#">{{ $penerangan->judul }}</a></h2>
                              <div class="post-meta">&nbsp;| {{ date('dMY',strtotime($penerangan->created_at)) }}| {{ $penerangan->kat }}
                              </div>
                            </div>
                            <div class="post-entry">
                              {!! Str::limit($penerangan->artikel, $limit = 100) !!}
                            </div>
                            <div class="post-more"><a class="more-link" href="{{url("/data/".$penerangan->slug)}}">Read more</a></div>
                          </div>
                        </div>
                        @endforeach
                </div>
